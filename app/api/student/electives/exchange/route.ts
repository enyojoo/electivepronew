...
export async function GET(request: NextRequest) {
  try {
    ...
    // Fetch published elective exchange programs for the student's group
    const { data: exchangePrograms, error } = await supabaseAdmin
    ...
    console.error("Unexpected error in student exchange electives API:", error)
